...
},{"jquery":"node_modules/jquery/dist/jquery.js","./util.js":"node_modules/bootstrap/js/dist/util.js"}],"node_modules/vue/dist/vue.common.dev.js":[function(require,module,exports) {
var global = arguments[3];
/*!
 * Vue.js v2.6.10
...
},{"./vue.common.dev.js":"node_modules/vue/dist/vue.common.dev.js"}],"data.json":[function(require,module,exports) {
module.exports = {
  "ayurveda": {
    "charaka": {
      "weight": {
...
var app = new _vue.default({
  ...
  methods: {
    ...
    fun_frominator: function fun_frominator() {
      if (this.metric === 'weight') {
        this.from = 'gram';
    ...
    fun_tonator: function fun_tonator() {
    ...
    convert: function convert(value, bool) {
      var switch_from = this.from;
      var switch_to = this.to;

      if (bool) {
        var _ref = [switch_to, switch_from];
        switch_from = _ref[0];
        switch_to = _ref[1];
      }

      var temp_from = data[this.system][this.author][this.metric][switch_from];
      var temp_to = data[this.system][this.author][this.metric][switch_to];
  ...
  computed: {
    metricator: function metricator() {
      return this.fun_metricator();
    },
    authory: function authory() {
      this.clear();
      return this.fun_authory();
    },
    frominator: function frominator() {
      return this.fun_frominator();
    },
    tonator: function tonator() {
...
},{"aos":"node_modules/aos/dist/aos.js","aos/dist/aos.css":"node_modules/aos/dist/aos.css","bootstrap/js/dist/collapse":"node_modules/bootstrap/js/dist/collapse.js","vue":"node_modules/vue/dist/vue.common.js","../data.json":"data.json"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
